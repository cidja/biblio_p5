                ...
                ?><div class="result"></div>
                    ...
                    <?php }; ?>
                        <div class="form-group d-flex flex-column">
                            <input type="number" class="form-control newPageCount" min="<?=$data2["new_page_count"]; ?>" max="<?= $data["page_count"]; //max value number of page of the $data ("page_count") ?>" 
                            placeholder="Nouveau numéro de pages " id="newPageCount" name="newPageCount" required>
                            
                            <button id="submitForm" type="" class="btn btn-success mt-2 submitNovelPageCount" data-id="<?= $data["id"];?>">Valider</button>
                        </div>
                    </form>
                </div>
...
?>
 <script src="public/js/ajax_NovelPageCount.js"></script>
<?php
