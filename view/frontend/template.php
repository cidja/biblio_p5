    ...
    <header>
        <!--Brand  source: https://www.w3schools.com/bootstrap4/bootstrap_navbar.asp !-->
            <nav class="navbar navbar-expand-md bg-success navbar-dark fixed-top">
                <a class="navbar-brand" title="page d'accueil" href="index.php?action=home">Prête ton livre</a>
            ...
            <div class="collapse navbar-collapse justify-content-md-end align-items-sm-start" id="collapsibleNavbar">
                ...
                <li class="nav-item ml-1">
                    <a class="nav-link" href="index.php?action=home">C'est quoi</a>
                </li>
                <li class="nav-item ml-2">
                    <a class="nav-link" href="index.php?action=listPosts">Trouve ton livre</a>
                </li>
                <li class="nav-item">
